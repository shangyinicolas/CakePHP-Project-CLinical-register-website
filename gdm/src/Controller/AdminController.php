...
class AdminController extends AppController
{
    ...
    public function index()
    {
        ...
        $query = $user->applyScope('index', $this->Admin->find('all'));
        $this->set('admin', $this->paginate($query));

        $patients = $this->loadModel('Patients')->find();
        $this->set('viewPatients', $patients);

        $clinicians = $this->loadModel('Clinicians')->find();
        $this->set('viewClinicians', $clinicians);

        $users = $this->loadModel('Users')->find();
        $this->set('viewUsers', $users);

        $assigned = $this->loadModel('Assigned')->find();
        $this->set('viewAssigned', $assigned);
    ...
    public function add()
    {
        ...
        $this->Authorization->authorize($this->admin);

            ...
            <div class="menu-inner">
                <nav>
                    <ul class="metismenu" id="menu">
                        ...
                        <li class = "active"><?= $this->Html->link(__('Notifications'), ['controller'=>'Notifications','action' => 'index']) ?></li>
                    </ul>
                </nav>
            </div>
        </div>
                                ...
                                <table id="dataTable" class="text-center">
                                    ...
                                    <?php foreach ($notifications as $notification): ?>
                                        <tr>
                                            ...
                                            <td><?= $notification->has('clinician') ? $this->Html->link($notification->clinician->FullName, ['controller' => 'Clinicians', 'action' => 'view', $notification->clinician->id]) : '' ?></td>
                                            <td><?= $notification->has('patient') ? $this->Html->link($notification->patient->FullName, ['controller' => 'Patients', 'action' => 'view', $notification->patient->id]) : '' ?></td>

            ...
            <div class="row align-items-center">
                <div class="col-sm-6">
                    <div class="breadcrumbs-area clearfix">
                        <h4 class="page-title pull-left">View Data Entry</h4>
                                        ...
                                        <div class="column-responsive column-80">
                                            <div class="data view content">
                                                <table>
                                                    ...
                                                    <tr>
                                                        <th><?= __('Weight') ?></th>
                                                        <td><?= $this->Number->format($data->Weight) ?></td>
                                                    </tr>
                                                    <tr>
                                                        <th><?= __('InsulinLevel') ?></th>
                                                        <td><?= $this->Number->format($data->InsulinLevel) ?></td>
                                                    </tr>
                                                    <tr>
                                                        <th><?= __('GlucoseLevel') ?></th>
                                                        <td><?= $this->Number->format($data->GlucoseLevel) ?></td>
                                                    </tr>
                                                    <tr>
                                                        <th><?= __('KetoneLevel') ?></th>
                                                        <td><?= $this->Number->format($data->KetoneLevel) ?></td>
                                                    </tr>
                                                    <tr>
                                                        <th><?= __('BloodPressure') ?></th>
                                                        <td><?= $this->Number->format($data->BloodPressure) ?></td>
                                                    </tr>
                                                    <tr>
                                                        <th><?= __('ReadingTime') ?></th>
                                                        <td><?= h($data->ReadingTime) ?></td>

                                                    </tr>
                                                    <tr>
                                                        <th><?= __('Patients Id') ?></th>
                                                        <td><?= $this->Number->format($data->patients_id) ?></td>
                                                    </tr>
                                                </table>
                                            </div>
                                        </div>

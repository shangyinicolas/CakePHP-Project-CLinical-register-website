                    ...
                    <ul class="metismenu" id="menu">
                        <li class="active">
                            <ul class="collapse">
                                ...
                                <li class = "active"><?= $this->Html->link(__('Data Entry'), ['controller'=>'Data','action' => 'index']) ?></li>
                            </ul>
                        </li>
                    </ul>
                </nav>
            ...
            <div class="row align-items-center">
                <div class="col-sm-6">
                    <div class="breadcrumbs-area clearfix">
                        ...
                        <ul class="breadcrumbs pull-left">
                            <li><?= $this->Html->link(__('Home'), ['controller'=>'Patient','action' => 'index']) ?></li>
                            <li><span>Add New entry</span></li>
                        </ul>
                    </div>
                </div>
                <div class="col-sm-6 clearfix">
                    <div class="user-profile pull-right">
                        ...
                        <h4 class="user-name dropdown-toggle" data-toggle="dropdown">Patient<i class="fa fa-angle-down"></i></h4>
        ...
        <div class="main-content-inner">
            <div class="row">
                <div class="col-12 mt-5">
                    <div class="card">
                        <div class="card-body">
                            <h4 class="header-title">Add new Entry</h4>
                            <div class="col-sm-6 col-md-4">
                                <div class="wow fadeInDown" data-wow-delay="0.1s">
                                    <div class="widget">
                                        <div class="row">
                                            <div class="column-responsive column-80">
                                                <div class="archive form content">
                                                    <?= $this->Form->create($data) ?>
                                                    <fieldset>
                                                        <legend><?= __('') ?></legend>
                                                        <a>Weight (kg)</a>
                                                        <?= $this->Form->control('Weight', ['required' => true,'label'=>false, 'min'=>0, 'max'=>300,'style'=>'width:50px; height:30px;']) ?>
                                                        <br>
                                                        <a>InsulinLevel (mIU/L)</a>
                                                        <?= $this->Form->control('InsulinLevel', ['required' => true,'label'=>false,'min'=>0, 'max'=>300]) ?>
                                                        <br>
                                                        <a>GlucoseLevel (mg/dl)</a>
                                                        <?= $this->Form->control('GlucoseLevel', ['required' => true,'label'=>false,'min'=>0, 'max'=>300]) ?>
                                                        <br>
                                                        <a>KetoneLevel (mmol/L)</a>
                                                        <?= $this->Form->control('KetoneLevel', ['required' => true,'label'=>false,'min'=>0, 'max'=>300]) ?>
                                                        <br>
                                                        <a>BloodPressure (mm Hg)</a>
                                                        <?= $this->Form->control('BloodPressure', ['required' => true,'label'=>false,'min'=>0, 'max'=>300]) ?>
                                                        <br>
                                                        <a>ReadingTime</a>
                                                        <?= $this->Form->control('ReadingTime', ['required' => true,'label'=>false,'min'=>0, 'max'=>300]) ?>
                                                        <br>

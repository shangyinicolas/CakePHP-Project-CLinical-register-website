            ...
            <div class="row align-items-center">
                <div class="col-sm-6">
                    <div class="breadcrumbs-area clearfix">
                        <h4 class="page-title pull-left">Edit Data Entry</h4>
                                    ...
                                    <div class="column-responsive column-80">
                                        <div class="data form content">
                                            ...
                                            <fieldset>
                                                ...
                                                echo $this->Form->control('InsulinLevel');
                                                echo $this->Form->control('GlucoseLevel');
                                                echo $this->Form->control('KetoneLevel');
                                                echo $this->Form->control('BloodPressure');
                                                echo $this->Form->control('ReadingTime');

            ...
            <div class="menu-inner">
                <nav>
                    <ul class="metismenu" id="menu">
                        ...
                        <li class = "active"><?= $this->Html->link(__('New Enquiry'), ['controller'=>'Enquiries','action' => 'add']) ?></li>
                ...
                <div class="col-sm-6">
                    <div class="breadcrumbs-area clearfix">
                        ...
                        <ul class="breadcrumbs pull-left">
                            <li><?= $this->Html->link(__('Home'), ['controller'=>'Patients','action' => 'index']) ?></li>
                            <li><span>new enquiry</span></li>
                        </ul>
                    </div>
                </div>
        ...
        <div class="main-content-inner">
            <div class="row">
                <div class="col-12 mt-5">
                    <div class="card">
                        <div class="card-body">
                            <h4 class="header-title">New Enquiry</h4>
                                        ...
                                        <div class="row">
                                            <div class="column-responsive column-80">
                                                <div class="clinicians form content">
                                                    ...
                                                    <fieldset>
                                                        <a>Full Name</a>
                                                        <?= $this->Form->control('full_name', ['required' => true,'label'=>false]) ?>
                                                        <br>
                                                        <a>Email</a>
                                                        <?= $this->Form->control('email', ['required' => true,'label'=>false]) ?>
                                                        <br>
                                                        <a>Title</a>
                                                        <?= $this->Form->control('description', ['required' => true,'label'=>false]) ?>
                                                        <br>
                                                        <a>Content</a>
                                                        <?= $this->Form->control('content', ['required' => true,'label'=>false]) ?>
                                                        <br>
                                                        <?=  $this->Form->control('email_sent',['type' => 'hidden','default'=>0])?>
                                                    </fieldset>

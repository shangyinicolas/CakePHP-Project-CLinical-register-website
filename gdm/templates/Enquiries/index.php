            ...
            <div class="menu-inner">
                <nav>
                    <ul class="metismenu" id="menu">
                        ...
                        <li class = "active"><?= $this->Html->link(__('Messages'), ['controller'=>'Enquiries','action' => 'index']) ?></li>
                            ...
                            <div class="data-tables">
                                <table id="dataTable" class="text-center">
                                    ...
                                    <tr>
                                        ...
                                        <th><?= $this->Paginator->sort('email_sent', 'Replied?') ?></th>
                                        <th><?= $this->Paginator->sort('date_sent', 'Date') ?></th>

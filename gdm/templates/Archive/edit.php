            ...
            <div class="menu-inner">
                <nav>
                    <ul class="metismenu" id="menu">
                        ...
                        <li><?= $this->Html->link(__('Archive'), ['controller'=>'Archive','action' => 'index']) ?></li>
                        </li>
                    </ul>
                </nav>
            </div>
                ...
                <div class="col-sm-6">
                    <div class="breadcrumbs-area clearfix">
                        ...
                        <ul class="breadcrumbs pull-left">
                            ...
                            <li><span>Add New Archive Document</span></li>
                        </ul>
                    </div>
                </div>
        ...
        <div class="main-content-inner">
            <div class="row">
                <div class="col-12 mt-5">
                    <div class="card">
                        <div class="card-body">
                            <h4 class="header-title">Add New Archive Document</h4>
                                            ...
                                            <div class="column-responsive column-80">
                                                <div class="archive form content">
                                                    ...
                                                    <fieldset>
                                                        <legend><?= __('') ?></legend>
                                                        <a>Name</a>
                                                        <?= $this->Form->control('name', ['required' => true,'label'=>false]) ?>
                                                        <br>
                                                        <a>Category</a>
                                                        <?= $this->Form->control('category', ['required' => true,'label'=>false]) ?>
                                                        <br>
                                                        <a>Link</a>
                                                        <?= $this->Form->control('link', ['required' => true,'label'=>false]) ?>
                                                        <br>
                                                    </fieldset>

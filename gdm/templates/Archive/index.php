                    ...
                    <nav>
                        <ul class="metismenu" id="menu">
                            <li class="active">
                                ...
                                <li class = "active"><?= $this->Html->link(__('Archive'), ['controller'=>'Archive','action' => 'index']) ?></li>
                            </li>
                        </ul>
                    </nav>
                </div>
            ...
            <div class="main-content-inner">
                <div class="row">
                    <div class="col-12 mt-5">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="header-title">Archive List</h4>
                                <div class="d-sm-flex align-items-center justify-content-between mb-4 pull-left">
                                    <h1 class="h3 mb-0 text-gray-800"></h1>
                                    <a href="<?= $this->url->build(['controller'=>'Archive','action' => 'add'])?>" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i
                                            class="fas fa-plus fa-sm text-white-50"></i> New Archive Entry</a>
                                </div>
                                        ...
                                        <?php foreach ($archive as $archive): ?>
                                            <tr>
                                                ...
                                                <td class="actions">
                                                    ...
                                                    <?= $this->Form->postLink(__('Delete'), ['action' => 'delete', $archive->id], ['confirm' => __('Are you sure you want to delete document #{0}?', $archive->id)]) ?>
                                                </td>
                                            </tr>
                                            <?php endforeach; ?>
                                        </tbody>

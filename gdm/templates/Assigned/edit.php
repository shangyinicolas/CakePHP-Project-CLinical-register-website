 ...
 * @var \Cake\Collection\CollectionInterface|string[] $clinicians
                ...
                <div class="col-sm-6">
                    <div class="breadcrumbs-area clearfix">
                        ...
                        <ul class="breadcrumbs pull-left">
                            ...
                            <li><span>Edit Clinician to Patient Assignment</span></li>
                        </ul>
                    </div>
                </div>
        ...
        <div class="main-content-inner">
            <div class="row">
                <div class="col-12 mt-5">
                    <div class="card">
                        <div class="card-body">
                            <h4 class="header-title">Edit Clinician to Patient Assignment</h4>
                            <div class="col-sm-6 col-md-4">
                                <div class="wow fadeInDown" data-wow-delay="0.1s">
                                    <div class="widget">
                                        <div class="row">
                                            <div class="column-responsive column-80">
                                                <div class="assigned form content">
                                                    <?= $this->Form->create($assigned) ?>
                                                    <fieldset>
                                                        <legend><?= __('') ?></legend>
                                                        <a>Clinician ID</a>
                                                        <?= $this->Form->control('clinicians_id', ['options' => $clinicians, 'required' => true,'label'=>false]) ?>
                                                        <br>
                                                        <a>Patient ID</a>
                                                        <?= $this->Form->control('patients_id', ['options' => $patients, 'required' => true,'label'=>false]) ?>
                                                    </fieldset>
                                                    <br>
                                                    <?= $this->Form->button(__('Re-Assign')) ?>
                                                    <?= $this->Form->end() ?>
                                                </div>
                                            </div>
                                        </div>
